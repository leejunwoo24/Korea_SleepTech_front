...
// # +) 객체의 구조적 타이핑(덕 타이핑)
// : 객체의 타입을 실제 값 보다는 그 구조나 멤버에 의해 결정하는 ㅂ장식
...
//userProfile.address.city = 'Daejeon'; // 일긱 전용 속성이므로 'city'에 할당할 수 없습니다.
