...
// export const tmp = '';
{
    ...
    //# 1) HTMLElement 타입 단언
    // HTMLElement; 모든 HTML 요소 타입의 d 요소를 가져올 때
    // - getElementById(), querySelector()로 HTML을 표현
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (button) {
            ...
            //button.disabled = true; // 'HTMLElement' 형식에 'disalbed' 속성이 없습니댜.
            button.disabled = true;
            // cf) HTMLElement의 하위 요서
...
var jsonString = '{"name": "LSA", "age": 29, "hobby": "exercise"}';
