...
var photoPerPage = 4; // 한 페이지에 표시에 사진의 수
...
function renderPhotos(photos) {
    ...
    photos.forEach(function (photo) {
        ...
        photoElement.className = "phopto-item";
        photoElement.innerHTML = "\n      <img src='".concat(photo.thumbnailUrl, "' alt= '").concat(photo.title, "' />\n      <p>").concat(photo.title, "</p>\n    ");
        container.appendChild(photoElement);
    });
}
//! 버튼 이벤트 등록
(_a = document.getElementById('perv-button')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', function () {
