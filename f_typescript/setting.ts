...
// Package name: package.json의 "name" 속성값으로 지정
// Select a framework: React
// Se;ect a variant: TypeScript
...
// 3. npm run preview: 빌드된 앱 미리보기 (bulid 후 사용 가능)
...
/*
{
  ...
  "type": "module",
  "scripts": {
    "dev": "vite", //! npm run 이후의 명령어
    "build": "tsc -b && vite build",
    "lint": "eslint .",
    "preview": "vite preview"
  },
  "dependencies": {  //! 애플리케이션 동작과 연관
...
export default defineConfig({
  plugins: [react()], //! React JSX를 인식하기 위한 필러그인
  resolve: {
    alias: {
