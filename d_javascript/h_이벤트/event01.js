...
// // : 0부터 100까지의 정수 생성 === Math.random() * (N + 1)
...
function randomColorFunc() {
  // 'rgb(r, g, b)' 형식과 동일
  // : r, g, b에 각각 0 부터 255까지의 무작위 정수 삽입
...
//#2) 인라인 이벤트 핸들러
// : HTML 태그에 직접 onClick, onkeydown등의 이벤트 속성을 사용하여 함수 지정
// - 사용하지 않는 것을 권장 (유지보수, 코드 파싱에 어려움)
...
// addEventListner()은 인자로 이벤트와 콜백함수를 받음
btnsButton.forEach(btn => {
  // btn은 Dom요소 (HTML 요소를 객체로 변환)
