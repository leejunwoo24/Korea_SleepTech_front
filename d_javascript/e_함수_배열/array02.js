...
// 2) 하나의 형태로 결합
let margeSports1 = [...sports, ...copy];
let margeSports2 = [...copy, ...sports];

console.log(margeSports1); //['축구', '야구', '농구', '배구', '축구', '야구', '농구','수영']
console.log(margeSports2); //['배구', '축구','야구', '농구','수영', '축구','야구', '농구']
