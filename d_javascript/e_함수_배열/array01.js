...
// 2) Array 생성자 사용 방식
// : 새로운 배열 생성 시 배열 크기, 또는 초기값 지정 가능

let arrayFruit1 =  new Array(3);
let arrayFruit2 =  new Array('사과', '오렌지', '망고');

// ! 2. 배열의 활용
// ? 1) 요소 접근 & 수정
const sports = ['축구', '야구', '농구'];

console.log(sports[1]); // 배열명[인덱스 번호] - 야구
...
let hasPotato = snacks.includes('포테이토칩');
...
// 1번째 매개변수에 할당된 인덱스번호를 기준 두 번째 매개변수에 할당된 인덱스 번호까지의 요소를 제외하고 나머지 요소 삭제
...
// 2) split(): 문자열 특정 구분자를 기준으로 분리하여 하나의 배열로 변환
let str1 = '사과,바나나,망고'
let str2 = '사과 바나나 망고'; 
let str3 = '사과-바나나-망고';
...
let contentsBox = ['넷플릭스', '유튜브', '디즈니플러스', '왓챠', '인스타그램'];

console.log(contentsBox.splice(1,3));