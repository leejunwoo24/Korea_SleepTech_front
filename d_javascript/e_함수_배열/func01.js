...
let result = sum(1, 2); // 함수 호출: 함수명(인자값 전달); 
console.log(result); // 3

let result2 = sum('이', '준우');
console.log(result2); // 이준우
...
// button1.addEventListener('click', message); // 'button' 요소에 클릭 이벤트 발생 시 message기능 적용
// button2.addEventListener('click', message); // 'button' 요소에 클릭 이벤트 발생 시 message기능 적용
