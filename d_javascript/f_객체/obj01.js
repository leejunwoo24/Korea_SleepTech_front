...
// - 값의 데이터 형식에 제한 X
//  : 배열, 또 다른 객체, 함수 가능
// - 키와 값을 하나의 쌍으로 나열, 각각의 쌓은 콤마(,)로 분리
// - 각각의 맴버(키와 값)은 콜론(:)으로 분리
...
// : 중괄호를 사용하여 객체를 선언하고 조기화 - 내부에 속성과 메서드 정의
...
let person1 = new Human(`이준우`, 178);
let person2 = new Human(`이가영`, 158);

console.log(person1.name);
console.log(person1.height);
person1.greet(); // Hello, 이준우

console.log(person2.name);
console.log(person2.height);
person2.greet(); // Hello, 이가영