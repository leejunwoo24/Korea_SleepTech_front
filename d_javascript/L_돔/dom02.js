...
document.addEventListener('DOMContentLoaded', () => {
  ...
  dogs.forEach((dog, index) => {
    ...
    dog.style.width = width;
    dog.style.height = '250px';

    const source = '../상위이미지.jpg';
    const alter = '강아지 이미지';

    //? cf) HTML 표준에 정의한 속성들은 setAttribute() 또는 getAttribute() 사용없이 객체 접근이 가능
