...
// : JS 내에서 문서 객체 조작 시, HTML의 모든 문서 구조(내용)기 모두 로드된 이후에 이벤트 발생

// document.addEventListener(`DOMContentLoaded`, () => {
  // .addEventListenter('이벤트', 콜백함수);
  // : 이벤트의 콜백함수는 화살표 함수 사용 권장
// });

//? 2) 문서 객체 가져오기

// 2-1) 전체 HTML 구조를 객체로 인식하여 속성을 가져옴(중첩 객체)
// : document.head / document.title 와 같이 중첩된 태그 구조를 객체처럼 인식한다.
