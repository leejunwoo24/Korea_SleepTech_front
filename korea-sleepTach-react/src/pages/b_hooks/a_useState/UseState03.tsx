...
//: EX) 클릭에 대한 변경 이벤트: React.ClickEvent
...
function UseState03() {
  ...
  return (
    <div>
      ...
      <input type="text" onChange={onNameInput} placeholder='이름을 입력해주세요' value={name} />

      <input type="text" onKeyDown={onEnterKeyboard} onChange={onEnterInput} placeholder='Enter 키를 눌러주세요' value={enter} readOnly />
    </div>
  )
}
