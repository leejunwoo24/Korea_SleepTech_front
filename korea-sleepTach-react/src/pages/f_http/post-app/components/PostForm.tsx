...
function PostForm() {
  ...
  return (
    <div>
      ...
      <input type="text" name='title'  value={title} onChange={handleInputValueChange} placeholder='제목'/>
      <br />
      <textarea value={body} name='body' onChange={handleInputValueChange} placeholder='내용'></textarea>
      <br />
